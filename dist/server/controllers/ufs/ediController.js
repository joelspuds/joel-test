...
exports.ediCompleteGet = ediCompleteGet;
...
function ediEthnicGroupPost(req, res) {
  ...
  if (ethnicity === 'Another ethnic group' || ethnicity === 'Prefer not to say' || ethnicity === '' || ethnicity === undefined || ethnicity === null) {
...
*************** */
function ediCompleteGet(req, res) {
  let viewData;
