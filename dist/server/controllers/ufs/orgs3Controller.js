...
exports.orgs3ConfigGet = orgs3ConfigGet;
exports.orgs3ConfigPost = orgs3ConfigPost;
exports.orgs3IndexGet = orgs3IndexGet;
exports.orgs3IndexPost = orgs3IndexPost;
exports.orgs3ApplicantsGet = orgs3ApplicantsGet;
exports.orgs3ApplicantsPost = orgs3ApplicantsPost;
exports.orgs3SelectRoleGet = orgs3SelectRoleGet;
exports.orgs3SelectRolePost = orgs3SelectRolePost;
exports.orgs3DetailsGet = orgs3DetailsGet;
exports.orgs3DetailsPost = orgs3DetailsPost;
exports.orgs3SearchGet = orgs3SearchGet;
exports.orgs3SearchPost = orgs3SearchPost;
exports.orgs3SearchResultsGet = orgs3SearchResultsGet;
exports.orgs3SearchResultsPost = orgs3SearchResultsPost;
exports.orgs3AddManuallyGet = orgs3AddManuallyGet;
exports.orgs3AddManuallyPost = orgs3AddManuallyPost;
...
//
// ************************************************************************
function orgs3ConfigGet(req, res) {
  let viewData;
...
function orgs3ConfigPost(req, res) {
...
//
// ************************************************************************
function orgs3IndexGet(req, res) {
  let viewData;
  // console.log(orgs3SessionData);
  let clearSession = req.param('clearSession');
  if (clearSession === 'true') {
...
function orgs3IndexPost(req, res) {
  const {} = req.body;
...
//
// ************************************************************************
function orgs3ApplicantsGet(req, res) {
  let viewData;
  ...
  if (userOneV3.firstName === undefined || userOneV3.firstName === 'null') {
    ...
    userTwoV3.detailsAdded = false;
    userFourV3.detailsAdded = false;
  } else if (userOneV3.firstName !== undefined && userTwoV3.firstName !== undefined && userThreeV3.firstName !== undefined && userFourV3.firstName === undefined) {
...
function orgs3ApplicantsPost(req, res) {
  const {} = req.body;
  return res.redirect('/prototypes/orgs3/');
}
...
//
// ************************************************************************
function orgs3SelectRoleGet(req, res) {
  let viewData;
  console.log(orgs3SessionData);
...
function orgs3SelectRolePost(req, res) {
...
//
// ************************************************************************
function orgs3DetailsGet(req, res) {
  let viewData;
...
function orgs3DetailsPost(req, res) {
...
//
// ************************************************************************
function orgs3SearchGet(req, res) {
  let viewData;
...
function orgs3SearchPost(req, res) {
...
//
// ************************************************************************
function orgs3SearchResultsGet(req, res) {
  let viewData;
...
function orgs3SearchResultsPost(req, res) {
...
//
// ************************************************************************
function orgs3AddManuallyGet(req, res) {
  let viewData;
...
function orgs3AddManuallyPost(req, res) {
