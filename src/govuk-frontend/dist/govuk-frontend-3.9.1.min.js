  ...
  (function(t) {
      ...
      'bind' in Function.prototype ||
        Object.defineProperty(Function.prototype, 'bind', {
          value: function(e) {
            ...
            return (
              (m = Function('binder', 'return function (' + g.join(',') + '){ return binder.apply(this, arguments); }')(function() {
              ...
              b.prototype && ((s.prototype = b.prototype), (m.prototype = new s()), (s.prototype = null)),
              m
            );
          },
        });
      ...
      ('DOMTokenList' in this && (!('classList' in (t = document.createElement('x'))) || (!t.classList.toggle('x', !1) && !t.className))) ||
            ...
            return function(i, r) {
                ...
                d = function() {
                  ...
                  for (
                    '' ===
                      (a =
                        'object' == typeof i[r]
                          ? ('' + i[r].baseVal).replace(/^\s+|\s+$/g, '').split(o)
                          : ('' + i[r]).replace(/^\s+|\s+$/g, '').split(o))[0] && (a = []),
                      c = {},
                      e = 0;
                    e < a.length;
                    ++e
              ...
              return (
                ...
                (s.add = function() {
                  ...
                  l !== a.length &&
                    ((l = a.length >>> 0), 'object' == typeof i[r] ? (i[r].baseVal = a.join(' ')) : (i[r] = a.join(' ')), u());
                }),
                (s.remove = function() {
                  d.apply(s, (t = arguments));
        ...
        'classList' in (n = document.createElement('span')) &&
          ...
          n.classList.contains('x') &&
            (n.classList.constructor.prototype.toggle = function(t) {
              var e = arguments[1];
        ...
        (function() {
          if (!window.Element || window.HTMLElement) {
            ...
            a.attachEvent('onpropertychange', function(t) {
              for (var e, n = t.propertyName, o = !c.hasOwnProperty(n), i = a[n], r = c[n], s = -1; (e = u[++s]); )
              ...
              r() || ((document.onreadystatechange = r), (t = setInterval(r, 25))),
          ...
          function r() {
            return (
              ...
              !(!document.body || document.body.prototype || !/(complete|interactive)/.test(document.readyState)) &&
                (l(document, !0), t && document.body.prototype && clearTimeout(t), !!document.body.prototype)
            );
          }
        })();
    }.call(('object' == typeof window && window) || ('object' == typeof self && self) || ('object' == typeof global && global) || {}),
    function(t) {
      ...
      ('document' in this &&
        ...
        (function(t) {
          ...
          h(t.Element, 'classList', 'className'),
            h(t.HTMLElement, 'classList', 'className'),
            h(t.HTMLLinkElement, 'relList', 'rel'),
            h(t.HTMLAnchorElement, 'relList', 'rel'),
            h(t.HTMLAreaElement, 'relList', 'rel');
        })(this);
    }.call(('object' == typeof window && window) || ('object' == typeof self && self) || ('object' == typeof global && global) || {}),
    ...
    (n.prototype.initHeaderAttributes = function(e, t) {
      ...
      s.setAttribute('type', 'button'),
        s.setAttribute('id', this.moduleId + '-heading-' + (t + 1)),
        s.setAttribute('aria-controls', this.moduleId + '-content-' + (t + 1));
      ...
      s.addEventListener('focusin', function(t) {
        ...
        null != r && s.setAttribute('aria-describedby', this.moduleId + '-summary-' + (t + 1)),
          ...
          if ('undefined' != typeof document && 'undefined' != typeof window) {
            ...
            (window.Event = Window.prototype.Event = function(t, e) {
              ...
              return (
                ...
                (n.bubbles = !(!e || e.bubbles === r) && e.bubbles),
                (n.cancelable = !(!e || e.cancelable === r) && e.cancelable),
                n
              );
            }),
              ...
              'createEvent' in document ||
                ((window.addEventListener = Window.prototype.addEventListener = Document.prototype.addEventListener = Element.prototype.addEventListener = function() {
                  ...
                  s._events || (s._events = {}),
                    s._events[t] ||
                      ((s._events[t] = function(t) {
                        var e,
                          n = s._events[t.type].list,
                          o = n.slice(),
                          i = -1,
                          r = o.length;
                        for (
                          t.preventDefault = function() {
                            ...
                            t.target = t.target || t.srcElement || s,
                          ...
                          i in o && -1 !== a(n, (e = o[i])) && 'function' == typeof e && e.call(s, t);
                      }),
                      (s._events[t].list = []),
                      s.attachEvent && s.attachEvent('on' + t, s._events[t])),
                    s._events[t].list.push(e);
                }),
                ...
                (window.dispatchEvent = Window.prototype.dispatchEvent = Document.prototype.dispatchEvent = Element.prototype.dispatchEvent = function(
                  ...
                  try {
                    ...
                    for (
                      t.target = e;
                      '_events' in (t.currentTarget = e) && 'function' == typeof e._events[n] && e._events[n].call(e, t),
  ...
  (i.prototype.init = function() {
    ...
    (i.prototype.polyfillDetails = function() {
      ...
      e &&
        ...
        !(e.tabIndex = 0) == (null !== t.getAttribute('open'))
          ? (e.setAttribute('aria-expanded', 'true'), n.setAttribute('aria-hidden', 'false'))
          : (e.setAttribute('aria-expanded', 'false'), n.setAttribute('aria-hidden', 'true'), (n.style.display = 'none')),
    ...
    (i.prototype.polyfillHandleInputs = function(t, n) {
      t.addEventListener('keypress', function(t) {
        ...
        (13 !== t.keyCode && 32 !== t.keyCode) ||
          ('summary' === e.nodeName.toLowerCase() && (t.preventDefault(), e.click ? e.click() : n(t)));
      }),
    ...
    (t.initAll = function h(t) {
      ...
      r(e.querySelectorAll('[data-module="govuk-button"]'), function(t) {
        ...
        new c(e.querySelector('[data-module="govuk-error-summary"]')).init(),
        new l(e.querySelector('[data-module="govuk-header"]')).init(),
