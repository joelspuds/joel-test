  ...
  describe('when JavaScript is available', () => {
    ...
    describe('when menu button is pressed', () => {
      ...
      it('adds the --open modifier class to the menu, making it visible', async () => {
        const hasOpenClass = await page.$eval('.govuk-header__navigation', el => el.classList.contains('govuk-header__navigation--open'));

        expect(hasOpenClass).toBeTruthy();
      });

      it('adds the --open modifier class to the menu button', async () => {
        const hasOpenClass = await page.$eval('.govuk-header__menu-button', el => el.classList.contains('govuk-header__menu-button--open'));
