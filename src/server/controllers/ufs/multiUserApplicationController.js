...
export function appV3AHRCOpportunityGet(req, res) {
  let viewData;
...
export function appV3AHRCOpportunityPost(req, res) {
  const {} = req.body;
...
export function appV3tinyMCEApplicationIndexGet(req, res) {
...
export function appV3tinyMCEApplicationIndexPost(req, res) {
...
//
// ************************************************************************
export function appV3tinyMCEApplicationViewGet(req, res) {
  let viewData;
...
//
// ************************************************************************
export function appV3AdminViewGet(req, res) {
...
export function appV3DetailsPost(req, res) {
...
export function appV3ApplicantsPost(req, res) {
...
export function appV3JustificationPost(req, res) {
  const { isComplete } = req.body;
...
export function appV3caseForSupportPost(req, res) {
...
export function appV3ResourcesAndCostsPost(req, res) {
