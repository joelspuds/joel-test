...
export const genericPeople = genericPeopleList;

let awardStatusesList = [
  'Active',
  'Announced',
  'Awaiting completion',
  ...
  'Finished',
  'Suspended',
  'UKRI Preparing Award',
  'Waiting for UKRI Authorisation',
];

export const awardStatuses = awardStatusesList;
